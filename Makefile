...
docker_build_app:
	docker build --tag shapesai/guineapig:v0.0.2 --file=docker/Dockerfile.app .
...
docker_run_app:
	docker run -d --rm --env-file .env --name guineapig -p 8080:8080 shapesai/guineapig:v0.0.2
